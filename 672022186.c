...
void volume(){
	...
	int sisi;
    float jbola, tprisma, aprisma, taprisma, tlimas, alimas;
    float vkubus, vprisma, vlimas, vbola;
    switch (volume2){
		case 1:
		    system("cls");
		    vkubus:
		...
		case 2:
    		...
    		scanf("%f", &taprisma);
    		vprisma = tprisma*(0.5*aprisma*taprisma);
			printf("Volume Prisma Adalah %.2f", vprisma);
            printf("\n");
            printf("ulang?(y/t)");
            scanf("%s", &t);
            if(strcmp(t,"y")==0||strcmp(t,"Y")==0){
		...
		case 3:
    		...
    		scanf("%f", &alimas);
			vlimas = 0.33 * alimas * tlimas;
			printf("Volume limas %.2f", vlimas);
            printf("\n");
            printf("ulang?(y/t)");
            scanf("%s", &t);
            if(strcmp(t,"y")==0||strcmp(t,"Y")==0){
		...
		case 4:
    		...
    		scanf("%f", &jbola);
			vbola=1.33*M_PI*jbola*jbola*jbola;
